  ...
  <div class="tallyBook">
    ...
    <main class="detail">
      <div class="detail-hd">
        ...
        <div class="total">
          支出:<span>{{expend}}</span>，收入:<span>{{income}}</span>
        </div>
      </div>
      <div class="detail-body">
        <ul class="detail-list">
          <li class="detail-item" v-for="(item,index) in detailList" :key="index">
            <div class="item-title">
              <img :src="item.src" alt="">
              <span>{{item.name}}</span>
            </div>
            <div class="subtotal" :class="{active:parseInt(item.subtotal)<0}">
